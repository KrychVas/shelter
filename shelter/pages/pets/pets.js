document.addEventListener('DOMContentLoaded', () => {
  ...
  function render() {
    ...
    pageItems.forEach(id => {
      ...
      gridContainer.insertAdjacentHTML('beforeend', `
        <div class="pet-card">
          <img src="${imgPrefix + pet.img}" alt="${pet.name}" class="pet-card__img">
  ...
  gitFirst = btnFirst.addEventListener('click', () => { if (currentPage !== 1) { currentPage = 1; render(); } });
